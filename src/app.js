...
import pricefeedabi from './abis/BNB_USD_Feed_Price.json';
...
// BSC TESTNET
//const BUSD_TOKEN_ADDRESS = '0xC44C492AE191ecDe390b6a0491e299577E3BF286';
const USDT_TOKEN_ADDRESS = '0x55d398326f99059fF775485246999027B3197955';
const PRICE_FEED_CONTRACT_ADDRESS = '0x137924D7C36816E0DcAF016eB617Cc2C92C05782';
...
export const App = () => {
  ...
  const getBNBPrice = async () => {
    let _PriceFeedContract = await PriceFeedContract();
    const priceFeed = await _PriceFeedContract.latestAnswer();
    const priceBnbUsdFeed = (priceFeed.toString() / 10 ** 8).toFixed(8);
    return priceBnbUsdFeed; 
  };
