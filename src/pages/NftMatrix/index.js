  ...
  return (
    <MainArea>
      ...
      <div className="list-area">
          ...
          {plans.map(plan => (
            <div className={
              plan.plan_no === 1 ? "list-item list-item-x3" :
              plan.plan_no === 2 ? "list-item list-item-x4" :
              plan.plan_no === 3 ? "list-item list-item-zzz" :
              plan.plan_no === 4 ? "list-item list-item-xgold" :
              ""
             }>
              <h3>
                {plan.plan_name} <span>{plan.amount} USDT</span>
              </h3>
              ...
              <li></li>
                ...
                <a href={`/${plan.plan_name}`}>
                  ...
                  <svg
                    ...
                    viewBox="0 0 16 16"
                  >
                  <path d="M0 8a8 8 0 1 0 16 0A8 8 0 0 0 0
